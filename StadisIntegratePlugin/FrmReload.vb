...
#Region " Data Declarations "
    ...
    Private mStatus As StadisIntegratePlugin.WebReference.TicketStatus = Nothing
...
#Region " Other Methods "
    ...
    Private Sub AddMoneyToSVAccount()
        Try
            ...
            End With
            Dim sys As StadisIntegratePlugin.WebReference.StadisReply = Common.StadisAPI.GCReload(sr)
