...
'----------------------------------------------------------------------------------------------
<GuidAttribute(Discover.CLASS_ButtonReturn)>
Public Class ButtonReturn
    ...
    Private Function DoCharge(ByVal tenderID As String, ByVal amount As Decimal) As Boolean
        Try
            ...
            End With
            Dim sy As StadisIntegratePlugin.WebReference.StadisReply() = Common.StadisAPI.SVAccountCharge(sr, Common.LoadHeader(fAdapter, "Receipt", invoiceHandle), Common.LoadItems(fAdapter, "Receipt", invoiceHandle, itemHandle), Common.LoadTenders(fAdapter, "Receipt", invoiceHandle, tenderHandle))
