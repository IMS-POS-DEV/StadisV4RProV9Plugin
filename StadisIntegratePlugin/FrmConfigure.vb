...
#Region " Buttons "
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        MsgBox("After saving, please close and re-open Retail Pro to initialize the applicable settings and licensing")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnLicenseCheck.Click
        'var config = ConfigurationManager.OpenExeConfiguration(ConfigurationUserLevel.PerUserRoamingAndLocal)
        '        Dim tmpConfig = System.Configuration.ConfigurationManager.OpenExeConfiguration(System.Configuration.ConfigurationUserLevel.PerUserRoamingAndLocal)
        '        MsgBox("config file: " & tmpConfig.FilePath)

        If gLicensesLoaded = False Then
            MsgBox("Please enter the sales receipts area once to trigger reading licensing and then return here to display the license information.")
            Exit Sub
        End If
        Dim strTemp As String = ""
        strTemp = "Retail Pro user ID: " & gRPROUID & vbCrLf &
                  "Company ID: " & gCompanyID & vbCrLf &
                   "Stadis Enabled: " & gStadisEnabled & vbCrLf &
                   "Tappit Enabled: " & gTappitEnabled & vbCrLf &
                   "Tappit API key: " & gTappitAPIKey & vbCrLf &
                   "Tappit URL    : " & gTappitBaseAddress
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Dim tmpConfig = System.Configuration.ConfigurationManager.OpenExeConfiguration(System.Configuration.ConfigurationUserLevel.PerUserRoamingAndLocal)
        Dim tmpConfigFolder = Path.GetDirectoryName(tmpConfig.FilePath)

        Process.Start("explorer.exe", Chr(34) & tmpConfigFolder & Chr(34))

    End Sub

    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        gDebugMode = Not (gDebugMode)
        If gDebugMode = True Then MsgBox("Debug mode is now ON")
        If gDebugMode = False Then MsgBox("Debugmode is now OFF")
    End Sub
