...
#Region " Form Load and Initialization "
    ...
    Private Sub GetHistory(ByVal TicketBarcode As String)
        Try
            ...
            ds.Clear()
            Dim mas As StadisIntegratePlugin.WebReference.MessageAndActionSummary = Common.StadisAPI.GetActionSummaryForTicket(TicketBarcode)
    ...
    Private Function FillTransactionDS(ByRef headers As StadisIntegratePlugin.WebReference.ActionHeader(), ByRef items As StadisIntegratePlugin.WebReference.ActionItem(), ByRef tenders As StadisIntegratePlugin.WebReference.ActionTender(), ByRef actions As StadisIntegratePlugin.WebReference.ActionSVAction()) As DataSet
        If Not (headers Is Nothing) Then
            For Each header As StadisIntegratePlugin.WebReference.ActionHeader In headers
            ...
            Next
            For Each itm As StadisIntegratePlugin.WebReference.ActionItem In items
                ...
                ds.Item.Rows.Add(dr)
            Next
            For Each tender As StadisIntegratePlugin.WebReference.ActionTender In tenders
        ...
        If Not (actions Is Nothing) Then
            For Each sa As StadisIntegratePlugin.WebReference.ActionSVAction In actions
    ...
    Private Sub ReverseSVAction(ByRef thisRow As UltraWinGrid.UltraGridRow)
        ...
        If FrmLoginMerge.ShowDialog() = Windows.Forms.DialogResult.OK Then
            Try
                ...
                End With
                Dim sy As StadisIntegratePlugin.WebReference.StadisReply() = Common.StadisAPI.SVAccountReverse(sr)
